...
bbn.exe: bbn.f90 driver.o $(modules) quadpack.a
	$(FORTRAN) $(F90FLAGS) bbn.f90 -o bbn.exe driver.o $(modules) quadpack.a

nuc123.exe: NUC123.f driver.o $(modules)
	$(FORTRAN) $(F77FLAGS) NUC123.f -o nuc123.exe driver.o $(modules)

driver.o: driver.f $(modules)
	$(FORTRAN) $(F77FLAGS) -c driver.f
